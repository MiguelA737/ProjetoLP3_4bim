...
namespace ProjetoLP3_4bim.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(LivrariasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,NomeUsuario,DataNascUsuario,TelUsuario,EmailUsuario")] Usuario usuario)
        {
