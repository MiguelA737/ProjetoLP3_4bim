...
namespace ProjetoLP3_4bim.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(LivrariasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,NomeAutor,DataNascAutor,NacionalidadeAutor,TelAutor,EmailAutor")] Autor autor)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
