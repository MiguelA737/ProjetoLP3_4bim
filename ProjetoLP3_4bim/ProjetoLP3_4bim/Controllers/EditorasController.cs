...
namespace ProjetoLP3_4bim.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public EditorasController(LivrariasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEditora,NomeEditora,TelEditora,EmailEditora")] Editora editora)
        {
